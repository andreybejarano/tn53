const listaPlatos = [
    ...
    },
    {
        ...
        descripcionDetallada: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sit mollitia ea, necessitatibus sequi, deserunt error exercitationem fuga explicabo laborum dolorum atque, quidem sint vero numquam consectetur eaque dolore unde at?',
        precio: '47.00',
...
const controller = {
    index: (req, res) => {
        res.render('index', { products: listaPlatos });
    },
    detail: (req, res) => {
        const product = listaPlatos.find(element => element.id == req.params.id);
